...
include("m4l2-lib-cor")
include("m4l1-lib-logging-common")
include("m5l3-repo-postgresql")
include("m5l1-repo-tests")
include("m5l1-repo-stubs")
include("m5l1-repo-in-memory")
include("m4l1-app-common")
include("m5l1-acceptance")
